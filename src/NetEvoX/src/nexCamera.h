 ...
 * nexCamera
 *
 * Class to control the movement of the camera in the scene. Currently not in 
 * use as we concentrate on good 2D views and camera movement is not necessary
 * for this scenario as a basic centroid is used.
 *
